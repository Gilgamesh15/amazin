...
-- CreateEnum
CREATE TYPE "FeaturedType" AS ENUM ('PRODUCT', 'CATEGORY');
...
-- CreateIndex
CREATE UNIQUE INDEX "Inventory_productId_productVariantId_location_key" ON "Inventory"("productId", "productVariantId", "location");
...
-- CreateIndex
CREATE UNIQUE INDEX "Featured_categoryId_key" ON "Featured"("categoryId");
